...
# Behavior #
Generates a fragMap from a specific range of fragment sizes over a chosen genomic interval. As an alternative, a fragMap of the centers can be generated by charting the midpoints of the fragments.
